...
import { Mail, Github, Linkedin, ExternalLink, Code, Database, Brain, BarChart3 } from 'lucide-react';

export default function AboutPage() {
  const skills = [
    { category: 'Machine Learning', items: ['Python', 'TensorFlow', 'PyTorch', 'Scikit-learn', 'XGBoost'], icon: Brain },
    { category: 'Data Engineering', items: ['SQL', 'PostgreSQL', 'MongoDB', 'Apache Spark', 'Airflow'], icon: Database },
    { category: 'Programming', items: ['Python', 'JavaScript', 'TypeScript', 'R', 'Bash'], icon: Code },
    { category: 'Analytics & Visualization', items: ['Tableau', 'Power BI', 'Matplotlib', 'Seaborn', 'Plotly'], icon: BarChart3 }
  ];
